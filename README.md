...
- [ ] [Key-Value Store](initial-kv)
- [ ] [Memcached](initial-memcached)
- [ ] [xv6 Intro](initial-xv6)
- [ ] [xv6 Tracer](initial-xv6-tracer)

### Processes and Scheduling

- [ ] [Shell](processes-shell)
- [ ] [xv6 Lottery Scheduling](scheduling-xv6-lottery)
...
- [ ] [Sort](concurrency-sort)
- [ ] [xv6 Threads](concurrency-xv6-threads)

### File Systems

- [ ] [File System Checker](filesystems-checker)
- [ ] [Distributed File Server](filesystems-distributed)
- [ ] [UDP-Based File Server](filesystems-distributed-ufs)
